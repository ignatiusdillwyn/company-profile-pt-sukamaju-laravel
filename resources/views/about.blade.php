...
@section('content')
    <!-- ========== PAGE HEADER ========== -->
    <section class="page-header mt-5" id="about">
        <div class="container">
    ...
    <section class="py-5" id="who-we-are">
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                {{-- <div class="col-lg-6">
                    <img src="https://placehold.co/600x400" alt="About Us" class="about-image img-fluid"
            ...
            <div class="timeline">
                <div class="timeline-item">
                    ...
                    <div class="timeline-content">
                        ...
                        <p class="text-muted small mb-0">DummyCorp was established with a vision to transform digital
                            experiences.</p>
                    </div>
                </div>
                <div class="timeline-item">
            ...
            <div class="row g-4">
                    ...
                    <div class="team-card">
                        <div class="team-img-wrapper">
                            <img width="300" height="300"
                                src="https://korika.id/wp-content/uploads/2017/10/speaker3-min.jpg" class="team-img rounded"
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-card">
                        <div class="team-img-wrapper">
                            <img width="300" height="300"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTej9k2T_wQEb6gBI5ZCrnp20ZedhgWZviSxtN_xv_PptnAAR5nlql9bQX6&s=10"
                                class="team-img rounded" alt="Jane Smith" class="team-img" />
                            <div class="team-social">
                                <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                                <a href="#"><i class="fab fa-github"></i></a>
                    ...
                    <div class="team-card">
                        <div class="team-img-wrapper">
                            <img width="300" height="300"
                                ...
                                class="team-img rounded" alt="Mike Johnson" class="team-img" />
                            <div class="team-social">
                                <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                                <a href="#"><i class="fab fa-github"></i></a>
                    ...
                    <div class="team-card">
                        <div class="team-img-wrapper">
                            <img width="300" height="300"
                                ...
                                class="team-img rounded" alt="Sarah Lee" />
                            <div class="team-social">
                                <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                                <a href="#"><i class="fab fa-github"></i></a>
